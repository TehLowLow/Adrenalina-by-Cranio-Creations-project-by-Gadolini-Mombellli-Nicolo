...
import it.polimi.se2019.Controller.Data.EffectBuilders.EffectExceptions.NoTargetException;
...
public class BBQMode extends Effect{
        ...
        public void applyEffect(Player user,  ArrayList <Player> targets) {
            ...
            Token newDamage1 = new Token();
            Token newDamage2 = new Token();
            newDamage1.setChampionName(user.getPlayerboard().getChampionName());
            newDamage2.setChampionName(user.getPlayerboard().getChampionName());
            damages.add(newDamage1);
            damages.add(newDamage2);
            ...
            if(targets.size() == 2){
                ...
                damages = target.getPlayerboard().getDamage();
